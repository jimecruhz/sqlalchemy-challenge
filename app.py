...
def home():
    return(
        ...
        f"<center><h2>Select from one of the available routes:</h3></center>"
...
def precip():
    #return the previous year's precipitation 
...
#/api/v1.0/start/end and /api/v1.0/start/start routes
